...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__DD21123",
    appName: "wifi-scan-qrcode",
    appVersion: "1.0.0",
    appVersionCode: "100",
  ...
  !function(t2, e2) {
    ...
    return function(t2) {
      ...
      function n2(r) {
        if (e2[r])
          return e2[r].exports;
        var o2 = e2[r] = { i: r, l: false, exports: {} };
        return t2[r].call(o2.exports, o2, o2.exports, n2), o2.l = true, o2.exports;
      }
      ...
      function r(t3) {
        if (t3)
          return function(t4) {
            for (var e3 in r.prototype)
              t4[e3] = r.prototype[e3];
            return t4;
          }(t3);
      }
      t2.exports = r, r.prototype.on = r.prototype.addEventListener = function(t3, e3) {
        return this._callbacks = this._callbacks || {}, (this._callbacks["$" + t3] = this._callbacks["$" + t3] || []).push(e3), this;
      }, r.prototype.once = function(t3, e3) {
        function n3() {
          this.off(t3, n3), e3.apply(this, arguments);
        }
        return n3.fn = e3, this.on(t3, n3), this;
      }, r.prototype.off = r.prototype.removeListener = r.prototype.removeAllListeners = r.prototype.removeEventListener = function(t3, e3) {
        if (this._callbacks = this._callbacks || {}, 0 == arguments.length)
          return this._callbacks = {}, this;
        var n3, r2 = this._callbacks["$" + t3];
        if (!r2)
          return this;
        if (1 == arguments.length)
          return delete this._callbacks["$" + t3], this;
        for (var o2 = 0; o2 < r2.length; o2++)
          if ((n3 = r2[o2]) === e3 || n3.fn === e3) {
            r2.splice(o2, 1);
            break;
          }
        return 0 === r2.length && delete this._callbacks["$" + t3], this;
      }, r.prototype.emit = function(t3) {
        this._callbacks = this._callbacks || {};
        for (var e3 = new Array(arguments.length - 1), n3 = this._callbacks["$" + t3], r2 = 1; r2 < arguments.length; r2++)
          e3[r2 - 1] = arguments[r2];
        if (n3) {
          r2 = 0;
          for (var o2 = (n3 = n3.slice(0)).length; r2 < o2; ++r2)
            n3[r2].apply(this, e3);
        }
        return this;
      }, r.prototype.listeners = function(t3) {
        return this._callbacks = this._callbacks || {}, this._callbacks["$" + t3] || [];
      }, r.prototype.hasListeners = function(t3) {
        return !!this.listeners(t3).length;
      };
    }, function(t2, e2, n2) {
      const r = n2(25), o2 = n2(26), s2 = String.fromCharCode(30);
      t2.exports = { protocol: 4, encodePacket: r, encodePayload: (t3, e3) => {
        const n3 = t3.length, o3 = new Array(n3);
        let i = 0;
        t3.forEach((t4, a) => {
          r(t4, false, (t5) => {
            o3[a] = t5, ++i === n3 && e3(o3.join(s2));
          });
        });
      }, decodePacket: o2, decodePayload: (t3, e3) => {
        const n3 = t3.split(s2), r2 = [];
        for (let t4 = 0; t4 < n3.length; t4++) {
          const s3 = o2(n3[t4], e3);
          if (r2.push(s3), "error" === s3.type)
            break;
        }
        return r2;
      } };
      ...
      const r = n2(2), o2 = n2(1), s2 = n2(0)("engine.io-client:transport");
      t2.exports = class extends o2 {
        ...
        onData(t3) {
          const e3 = r.decodePacket(t3, this.socket.binaryType);
          this.onPacket(e3);
        }
        onPacket(t3) {
          this.emit("packet", t3);
      ...
      e2.encode = function(t3) {
        ...
        for (var e3 = {}, n2 = t3.split("&"), r = 0, o2 = n2.length; r < o2; r++) {
          var s2 = n2[r].split("=");
      ...
      const r = n2(1), o2 = n2(38), s2 = n2(16), i = n2(0)("socket.io-parser");
      var a;
      ...
      }(a = e2.PacketType || (e2.PacketType = {}));
      e2.Encoder = class {
        encode(t3) {
          return i("encoding packet %j", t3), t3.type !== a.EVENT && t3.type !== a.ACK || !s2.hasBinary(t3) ? [this.encodeAsString(t3)] : (t3.type = t3.type === a.EVENT ? a.BINARY_EVENT : a.BINARY_ACK, this.encodeAsBinary(t3));
        }
        encodeAsString(t3) {
          let e3 = "" + t3.type;
          return t3.type !== a.BINARY_EVENT && t3.type !== a.BINARY_ACK || (e3 += t3.attachments + "-"), t3.nsp && "/" !== t3.nsp && (e3 += t3.nsp + ","), null != t3.id && (e3 += t3.id), null != t3.data && (e3 += JSON.stringify(t3.data)), i("encoded %j as %s", t3, e3), e3;
        }
        encodeAsBinary(t3) {
          const e3 = o2.deconstructPacket(t3), n3 = this.encodeAsString(e3.packet), r2 = e3.buffers;
          return r2.unshift(n3), r2;
        }
      };
      class c extends r {
        constructor() {
        ...
        add(t3) {
          let e3;
          if ("string" == typeof t3)
            e3 = this.decodeString(t3), e3.type === a.BINARY_EVENT || e3.type === a.BINARY_ACK ? (this.reconstructor = new h(e3), 0 === e3.attachments && super.emit("decoded", e3)) : super.emit("decoded", e3);
          else {
        ...
        decodeString(t3) {
          ...
          if (n3.type === a.BINARY_EVENT || n3.type === a.BINARY_ACK) {
            const r3 = e3 + 1;
            for (; "-" !== t3.charAt(++e3) && e3 != t3.length; )
              ;
            const o3 = t3.substring(r3, e3);
          ...
          if ("/" === t3.charAt(e3 + 1)) {
            ...
            n3.nsp = t3.substring(r3, e3);
          } else
            n3.nsp = "/";
          const r2 = t3.charAt(e3 + 1);
          if ("" !== r2 && Number(r2) == r2) {
            const r3 = e3 + 1;
            for (; ++e3; ) {
            ...
            n3.id = Number(t3.substring(r3, e3 + 1));
          }
          if (t3.charAt(++e3)) {
            ...
            if (!c.isPayloadValid(n3.type, r3))
              throw new Error("invalid payload");
            n3.data = r3;
          }
          return i("decoded %s as %j", t3, n3), n3;
        }
      ...
      var n2 = /^(?:(?![^:@]+:[^:@\/]*@)(http|https|ws|wss):\/\/)?((?:(([^:@]*)(?::([^:@]*))?)?@)?((?:[a-f0-9]{0,4}:){2,7}[a-f0-9]{0,4}|[^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/, r = ["source", "protocol", "authority", "userInfo", "user", "password", "host", "port", "relative", "path", "directory", "file", "query", "anchor"];
      t2.exports = function(t3) {
        ...
        for (var i, a, c = n2.exec(t3 || ""), h = {}, u = 14; u--; )
          h[r[u]] = c[u] || "";
        return -1 != o2 && -1 != s2 && (h.source = e3, h.host = h.host.substring(1, h.host.length - 1).replace(/;/g, ":"), h.authority = h.authority.replace("[", "").replace("]", "").replace(/;/g, ":"), h.ipv6uri = true), h.pathNames = function(t4, e4) {
          var n3 = e4.replace(/\/{2,9}/g, "/").split("/");
          "/" != e4.substr(0, 1) && 0 !== e4.length || n3.splice(0, 1);
          "/" == e4.substr(e4.length - 1, 1) && n3.splice(n3.length - 1, 1);
          return n3;
        }(0, h.path), h.queryKey = (i = h.query, a = {}, i.replace(/(?:^|&)([^&=]*)=?([^&]*)/g, function(t4, e4, n3) {
          e4 && (a[e4] = n3);
        }), a), h;
      };
    }, function(t2, e2, n2) {
      Object.defineProperty(e2, "__esModule", { value: true }), e2.Manager = void 0;
      const r = n2(21), o2 = n2(15), s2 = n2(1), i = n2(6), a = n2(17), c = n2(39), h = n2(0)("socket.io-client:manager");
      e2.Manager = class extends s2 {
        constructor(t3, e3) {
          super(), this.nsps = {}, this.subs = [], t3 && "object" == typeof t3 && (e3 = t3, t3 = void 0), (e3 = e3 || {}).path = e3.path || "/socket.io", this.opts = e3, this.reconnection(false !== e3.reconnection), this.reconnectionAttempts(e3.reconnectionAttempts || 1 / 0), this.reconnectionDelay(e3.reconnectionDelay || 1e3), this.reconnectionDelayMax(e3.reconnectionDelayMax || 5e3), this.randomizationFactor(e3.randomizationFactor || 0.5), this.backoff = new c({ min: this.reconnectionDelay(), max: this.reconnectionDelayMax(), jitter: this.randomizationFactor() }), this.timeout(null == e3.timeout ? 2e4 : e3.timeout), this._readyState = "closed", this.uri = t3;
          const n3 = e3.parser || i;
        ...
        open(t3) {
          ...
          const o3 = a.on(e3, "open", function() {
            n3.onopen(), t3 && t3();
          }), s3 = a.on(e3, "error", (e4) => {
            h("error"), n3.cleanup(), n3._readyState = "closed", super.emit("error", e4), t3 ? t3(e4) : n3.maybeReconnectOnOpen();
          });
          if (false !== this._timeout) {
            const t4 = this._timeout;
            h("connect attempt will timeout after %d", t4), 0 === t4 && o3();
            const n4 = setTimeout(() => {
              h("connect attempt timed out after %d", t4), o3(), e3.close(), e3.emit("error", new Error("timeout"));
            }, t4);
        ...
        onopen() {
          ...
          this.subs.push(a.on(t3, "ping", this.onping.bind(this)), a.on(t3, "data", this.ondata.bind(this)), a.on(t3, "error", this.onerror.bind(this)), a.on(t3, "close", this.onclose.bind(this)), a.on(this.decoder, "decoded", this.ondecoded.bind(this)));
        }
        onping() {
          super.emit("ping");
        }
        ...
        onerror(t3) {
          h("error", t3), super.emit("error", t3);
        }
        socket(t3, e3) {
          let n3 = this.nsps[t3];
        ...
        _destroy(t3) {
          ...
          for (const t4 of e3) {
            if (this.nsps[t4].active)
              return void h("socket %s is still active, skipping close", t4);
          }
          this._close();
        }
        _packet(t3) {
          h("writing packet %j", t3), t3.query && 0 === t3.type && (t3.nsp += "?" + t3.query);
          const e3 = this.encoder.encode(t3);
          for (let n3 = 0; n3 < e3.length; n3++)
            this.engine.write(e3[n3], t3.options);
        }
        cleanup() {
          h("cleanup"), this.subs.forEach((t3) => t3()), this.subs.length = 0, this.decoder.destroy();
        }
        _close() {
        ...
        onclose(t3) {
          h("onclose"), this.cleanup(), this.backoff.reset(), this._readyState = "closed", super.emit("close", t3), this._reconnection && !this.skipReconnect && this.reconnect();
        }
        reconnect() {
          ...
          if (this.backoff.attempts >= this._reconnectionAttempts)
            ...
            h("will wait %dms before reconnect attempt", e3), this._reconnecting = true;
            const n3 = setTimeout(() => {
              t3.skipReconnect || (h("attempting reconnect"), super.emit("reconnect_attempt", t3.backoff.attempts), t3.skipReconnect || t3.open((e4) => {
                e4 ? (h("reconnect attempt error"), t3._reconnecting = false, t3.reconnect(), super.emit("reconnect_error", e4)) : (h("reconnect success"), t3.onreconnect());
              }));
            }, e3);
            this.subs.push(function() {
              clearTimeout(n3);
      ...
      const r = n2(10), o2 = n2(24), s2 = n2(28), i = n2(29);
      e2.polling = function(t3) {
        let e3, n3 = false, i2 = false;
        const a = false !== t3.jsonp;
        if ("undefined" != typeof location) {
          const e4 = "https:" === location.protocol;
          let r2 = location.port;
          r2 || (r2 = e4 ? 443 : 80), n3 = t3.hostname !== location.hostname || r2 !== t3.port, i2 = t3.secure !== e4;
        }
        if (t3.xdomain = n3, t3.xscheme = i2, e3 = new r(t3), "open" in e3 && !t3.forceJSONP)
          return new o2(t3);
        if (!a)
      ...
      const r = n2(23), o2 = n2(3);
      t2.exports = function(t3) {
        const e3 = t3.xdomain, n3 = t3.xscheme, s2 = t3.enablesXDR;
        try {
          if ("undefined" != typeof XMLHttpRequest && (!e3 || r))
      ...
      const r = n2(4), o2 = n2(5), s2 = n2(2), i = n2(13), a = n2(0)("engine.io-client:polling");
      t2.exports = class extends r {
        get name() {
          return "polling";
        }
        doOpen() {
        ...
        pause(t3) {
          const e3 = this;
          function n3() {
            a("paused"), e3.readyState = "paused", t3();
          }
          if (this.readyState = "pausing", this.polling || !this.writable) {
            let t4 = 0;
            this.polling && (a("we are currently polling - waiting to pause"), t4++, this.once("pollComplete", function() {
              a("pre-pause polling complete"), --t4 || n3();
            })), this.writable || (a("we are currently writing - waiting to pause"), t4++, this.once("drain", function() {
              a("pre-pause writing complete"), --t4 || n3();
            }));
          } else
            n3();
        }
        ...
        onData(t3) {
          const e3 = this;
          a("polling got data %s", t3);
          s2.decodePayload(t3, this.socket.binaryType).forEach(function(t4, n3, r2) {
        ...
        doClose() {
          const t3 = this;
          function e3() {
            a("writing close packet"), t3.write([{ type: "close" }]);
          }
          "open" === this.readyState ? (a("transport open - closing"), e3()) : (a("transport not open - deferring close"), this.once("open", e3));
        }
        write(t3) {
        ...
        uri() {
          ...
          let n3 = "";
          false !== this.opts.timestampRequests && (t3[this.opts.timestampParam] = i()), this.supportsBinary || t3.sid || (t3.b64 = 1), t3 = o2.encode(t3), this.opts.port && ("https" === e3 && 443 !== Number(this.opts.port) || "http" === e3 && 80 !== Number(this.opts.port)) && (n3 = ":" + this.opts.port), t3.length && (t3 = "?" + t3);
      ...
      t2.exports = { PACKET_TYPES: n2, PACKET_TYPES_REVERSE: r, ERROR_PACKET: { type: "error", data: "parser error" } };
    }, function(t2, e2, n2) {
      var r, o2 = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-_".split(""), s2 = {}, i = 0, a = 0;
      function c(t3) {
        var e3 = "";
        do {
      ...
      function h() {
        var t3 = c(+/* @__PURE__ */ new Date());
        return t3 !== r ? (i = 0, r = t3) : t3 + "." + c(i++);
      }
      for (; a < 64; a++)
        s2[o2[a]] = a;
      h.encode = c, h.decode = function(t3) {
        var e3 = 0;
        for (a = 0; a < t3.length; a++)
          e3 = 64 * e3 + s2[t3.charAt(a)];
        return e3;
      }, t2.exports = h;
    }, function(t2, e2) {
      ...
      const r = n2(6), o2 = n2(1), s2 = n2(17), i = n2(0)("socket.io-client:socket"), a = Object.freeze({ connect: 1, connect_error: 1, disconnect: 1, disconnecting: 1, newListener: 1, removeListener: 1 });
      e2.Socket = class extends o2 {
        ...
        emit(t3, ...e3) {
          if (a.hasOwnProperty(t3))
            throw new Error('"' + t3 + '" is a reserved event name');
          e3.unshift(t3);
          const n3 = { type: r.PacketType.EVENT, data: e3, options: {} };
          n3.options.compress = false !== this.flags.compress, "function" == typeof e3[e3.length - 1] && (i("emitting packet with ack id %d", this.ids), this.acks[this.ids] = e3.pop(), n3.id = this.ids++);
          const o3 = this.io.engine && this.io.engine.transport && this.io.engine.transport.writable;
          return this.flags.volatile && (!o3 || !this.connected) ? i("discard packet as the transport is not currently writable") : this.connected ? this.packet(n3) : this.sendBuffer.push(n3), this.flags = {}, this;
        }
        packet(t3) {
          t3.nsp = this.nsp, this.io._packet(t3);
        }
        onopen() {
          i("transport is open - connecting"), "function" == typeof this.auth ? this.auth((t3) => {
            this.packet({ type: r.PacketType.CONNECT, data: t3 });
        ...
        onclose(t3) {
          i("close (%s)", t3), this.connected = false, this.disconnected = true, delete this.id, super.emit("disconnect", t3);
        }
        onpacket(t3) {
          if (t3.nsp === this.nsp)
            switch (t3.type) {
        ...
        onevent(t3) {
          const e3 = t3.data || [];
          i("emitting event %j", e3), null != t3.id && (i("attaching ack callback to event"), e3.push(this.ack(t3.id))), this.connected ? this.emitEvent(e3) : this.receiveBuffer.push(Object.freeze(e3));
        }
        emitEvent(t3) {
        ...
        ack(t3) {
          ...
          let n3 = false;
          return function(...o3) {
            n3 || (n3 = true, i("sending ack %j", o3), e3.packet({ type: r.PacketType.ACK, id: t3, data: o3 }));
          };
        }
        onack(t3) {
          const e3 = this.acks[t3.id];
          "function" == typeof e3 ? (i("calling ack %s with %j", t3.id, t3.data), e3.apply(this, t3.data), delete this.acks[t3.id]) : i("bad ack %s", t3.id);
        }
        onconnect(t3) {
          i("socket connected with id %s", t3), this.id = t3, this.connected = true, this.disconnected = false, super.emit("connect"), this.emitBuffered();
        }
        emitBuffered() {
      ...
      const r = "function" == typeof ArrayBuffer, o2 = Object.prototype.toString, s2 = "function" == typeof Blob || "undefined" != typeof Blob && "[object BlobConstructor]" === o2.call(Blob), i = "function" == typeof File || "undefined" != typeof File && "[object FileConstructor]" === o2.call(File);
      function a(t3) {
        return r && (t3 instanceof ArrayBuffer || ((t4) => "function" == typeof ArrayBuffer.isView ? ArrayBuffer.isView(t4) : t4.buffer instanceof ArrayBuffer)(t3)) || s2 && t3 instanceof Blob || i && t3 instanceof File;
      }
      e2.isBinary = a, e2.hasBinary = function t3(e3, n3) {
        if (!e3 || "object" != typeof e3)
          return false;
        if (Array.isArray(e3)) {
          for (let n4 = 0, r2 = e3.length; n4 < r2; n4++)
            if (t3(e3[n4]))
              return true;
          return false;
        }
      ...
      const r = n2(20), o2 = n2(8), s2 = n2(15);
      Object.defineProperty(e2, "Socket", { enumerable: true, get: function() {
        return s2.Socket;
      } });
      const i = n2(0)("socket.io-client");
      t2.exports = e2 = c;
      const a = e2.managers = {};
      function c(t3, e3) {
        "object" == typeof t3 && (e3 = t3, t3 = void 0), e3 = e3 || {};
        const n3 = r.url(t3), s3 = n3.source, c2 = n3.id, h2 = n3.path, u2 = a[c2] && h2 in a[c2].nsps;
        let p2;
        return e3.forceNew || e3["force new connection"] || false === e3.multiplex || u2 ? (i("ignoring socket cache for %s", s3), p2 = new o2.Manager(s3, e3)) : (a[c2] || (i("new io instance for %s", s3), a[c2] = new o2.Manager(s3, e3)), p2 = a[c2]), n3.query && !e3.query && (e3.query = n3.query), p2.socket(n3.path, e3);
      }
      e2.io = c;
      var h = n2(6);
      ...
      const r = n2(7), o2 = n2(0)("socket.io-client:url");
      e2.url = function(t3, e3) {
        let n3 = t3;
        e3 = e3 || "undefined" != typeof location && location, null == t3 && (t3 = e3.protocol + "//" + e3.host), "string" == typeof t3 && ("/" === t3.charAt(0) && (t3 = "/" === t3.charAt(1) ? e3.protocol + t3 : e3.host + t3), /^(https?|wss?):\/\//.test(t3) || (o2("protocol-less url %s", t3), t3 = void 0 !== e3 ? e3.protocol + "//" + t3 : "https://" + t3), o2("parse %s", t3), n3 = r(t3)), n3.port || (/^(http|ws)$/.test(n3.protocol) ? n3.port = "80" : /^(http|ws)s$/.test(n3.protocol) && (n3.port = "443")), n3.path = n3.path || "/";
      ...
      const r = n2(22);
      t2.exports = (t3, e3) => new r(t3, e3), t2.exports.Socket = r, t2.exports.protocol = r.protocol, t2.exports.Transport = n2(4), t2.exports.transports = n2(9), t2.exports.parser = n2(2);
    }, function(t2, e2, n2) {
      const r = n2(9), o2 = n2(1), s2 = n2(0)("engine.io-client:socket"), i = n2(2), a = n2(7), c = n2(5);
      class h extends o2 {
        constructor(t3, e3 = {}) {
          super(), t3 && "object" == typeof t3 && (e3 = t3, t3 = null), t3 ? (t3 = a(t3), e3.hostname = t3.host, e3.secure = "https" === t3.protocol || "wss" === t3.protocol, e3.port = t3.port, t3.query && (e3.query = t3.query)) : e3.host && (e3.hostname = a(e3.host).host), this.secure = null != e3.secure ? e3.secure : "undefined" != typeof location && "https:" === location.protocol, e3.hostname && !e3.port && (e3.port = this.secure ? "443" : "80"), this.hostname = e3.hostname || ("undefined" != typeof location ? location.hostname : "localhost"), this.port = e3.port || ("undefined" != typeof location && location.port ? location.port : this.secure ? 443 : 80), this.transports = e3.transports || ["polling", "websocket"], this.readyState = "", this.writeBuffer = [], this.prevBufferLen = 0, this.opts = Object.assign({ path: "/engine.io", agent: false, withCredentials: false, upgrade: true, jsonp: true, timestampParam: "t", rememberUpgrade: false, rejectUnauthorized: true, perMessageDeflate: { threshold: 1024 }, transportOptions: {} }, e3), this.opts.path = this.opts.path.replace(/\/$/, "") + "/", "string" == typeof this.opts.query && (this.opts.query = c.decode(this.opts.query)), this.id = null, this.upgrades = null, this.pingInterval = null, this.pingTimeout = null, this.pingTimeoutTimer = null, "function" == typeof addEventListener && (addEventListener("beforeunload", () => {
        ...
        createTransport(t3) {
          ...
          e3.EIO = i.protocol, e3.transport = t3, this.id && (e3.sid = this.id);
          ...
          return s2("options: %j", n3), new r[t3](n3);
        }
        open() {
          let t3;
        ...
        probe(t3) {
          ...
          function o3() {
            if (r2.onlyBinaryUpgrades) {
              const t4 = !this.supportsBinary && r2.transport.supportsBinary;
              n3 = n3 || t4;
            }
            n3 || (s2('probe transport "%s" opened', t3), e3.send([{ type: "ping", data: "probe" }]), e3.once("packet", function(o4) {
              if (!n3)
                if ("pong" === o4.type && "probe" === o4.data) {
                  if (s2('probe transport "%s" pong', t3), r2.upgrading = true, r2.emit("upgrading", e3), !e3)
                    return;
                  h.priorWebsocketSuccess = "websocket" === e3.name, s2('pausing current transport "%s"', r2.transport.name), r2.transport.pause(function() {
                    n3 || "closed" !== r2.readyState && (s2("changing transport and sending upgrade packet"), f2(), r2.setTransport(e3), e3.send([{ type: "upgrade" }]), r2.emit("upgrade", e3), e3 = null, r2.upgrading = false, r2.flush());
                  });
                } else {
                  s2('probe transport "%s" failed', t3);
                  const n4 = new Error("probe error");
                  n4.transport = e3.name, r2.emit("upgradeError", n4);
                }
            }));
          }
          function i2() {
          ...
          function a2(n4) {
            ...
            o4.transport = e3.name, i2(), s2('probe transport "%s" failed because of error: %s', t3, n4), r2.emit("upgradeError", o4);
          }
          function c2() {
            a2("transport closed");
          }
          ...
          function p2(t4) {
            e3 && t4.name !== e3.name && (s2('"%s" works - aborting "%s"', t4.name, e3.name), i2());
          }
          function f2() {
            e3.removeListener("open", o3), e3.removeListener("error", a2), e3.removeListener("close", c2), r2.removeListener("close", u), r2.removeListener("upgrading", p2);
          }
          h.priorWebsocketSuccess = false, e3.once("open", o3), e3.once("error", a2), e3.once("close", c2), this.once("close", u), this.once("upgrading", p2), e3.open();
        }
        onOpen() {
          if (s2("socket open"), this.readyState = "open", h.priorWebsocketSuccess = "websocket" === this.transport.name, this.emit("open"), this.flush(), "open" === this.readyState && this.opts.upgrade && this.transport.pause) {
        ...
        sendPacket(t3, e3, n3, r2) {
          if ("function" == typeof e3 && (r2 = e3, e3 = void 0), "function" == typeof n3 && (r2 = n3, n3 = null), "closing" === this.readyState || "closed" === this.readyState)
            return;
          (n3 = n3 || {}).compress = false !== n3.compress;
          const o3 = { type: t3, data: e3, options: n3 };
          this.emit("packetCreate", o3), this.writeBuffer.push(o3), r2 && this.once("flush", r2), this.flush();
        }
        close() {
          const t3 = this;
          function e3() {
          ...
          return "opening" !== this.readyState && "open" !== this.readyState || (this.readyState = "closing", this.writeBuffer.length ? this.once("drain", function() {
            this.upgrading ? r2() : e3();
          }) : this.upgrading ? r2() : e3()), this;
        }
        onError(t3) {
          s2("socket error %j", t3), h.priorWebsocketSuccess = false, this.emit("error", t3), this.onClose("transport error", t3);
        }
        onClose(t3, e3) {
          if ("opening" === this.readyState || "open" === this.readyState || "closing" === this.readyState) {
      ...
      h.priorWebsocketSuccess = false, h.protocol = i.protocol, t2.exports = h;
    }, function(t2, e2) {
      try {
      ...
      const r = n2(10), o2 = n2(11), s2 = n2(1), { pick: i } = n2(14), a = n2(3), c = n2(0)("engine.io-client:polling-xhr");
      function h() {
      }
      ...
      class p2 extends s2 {
        ...
        create() {
          const t3 = i(this.opts, "agent", "enablesXDR", "pfx", "key", "passphrase", "cert", "ca", "ciphers", "rejectUnauthorized", "autoUnref");
          t3.xdomain = !!this.opts.xd, t3.xscheme = !!this.opts.xs;
          const e3 = this.xhr = new r(t3), n3 = this;
          try {
            c("xhr open %s: %s", this.method, this.uri), e3.open(this.method, this.uri, this.async);
            try {
            ...
            }, c("xhr data %s", this.data), e3.send(this.data);
          } catch (t4) {
            return void setTimeout(function() {
              n3.onError(t4);
            }, 0);
        ...
        cleanup(t3) {
          if (void 0 !== this.xhr && null !== this.xhr) {
            if (this.hasXDR() ? this.xhr.onload = this.xhr.onerror = h : this.xhr.onreadystatechange = h, t3)
              try {
                this.xhr.abort();
              } catch (t4) {
              }
      ...
      if (p2.requestsCount = 0, p2.requests = {}, "undefined" != typeof document) {
        if ("function" == typeof attachEvent)
          ...
          addEventListener("onpagehide" in a ? "pagehide" : "unload", f2, false);
        }
      }
      function f2() {
      ...
      const { PACKET_TYPES: r } = n2(12), o2 = "function" == typeof Blob || "undefined" != typeof Blob && "[object BlobConstructor]" === Object.prototype.toString.call(Blob), s2 = "function" == typeof ArrayBuffer, i = (t3, e3) => {
      ...
      t2.exports = ({ type: t3, data: e3 }, n3, a) => {
        return o2 && e3 instanceof Blob ? n3 ? a(e3) : i(e3, a) : s2 && (e3 instanceof ArrayBuffer || (c = e3, "function" == typeof ArrayBuffer.isView ? ArrayBuffer.isView(c) : c && c.buffer instanceof ArrayBuffer)) ? n3 ? a(e3 instanceof ArrayBuffer ? e3 : e3.buffer) : i(new Blob([e3]), a) : a(r[t3] + (e3 || ""));
        var c;
      };
    }, function(t2, e2, n2) {
      const { PACKET_TYPES_REVERSE: r, ERROR_PACKET: o2 } = n2(12);
      let s2;
      ...
      t2.exports = (t3, e3) => {
        if ("string" != typeof t3)
          return { type: "message", data: a(t3, e3) };
        const n3 = t3.charAt(0);
        if ("b" === n3)
          return { type: "message", data: i(t3.substring(1), e3) };
        return r[n3] ? t3.length > 1 ? { type: r[n3], data: t3.substring(1) } : { type: r[n3] } : o2;
      };
    }, function(t2, e2) {
      !function(t3) {
        e2.encode = function(e3) {
          var n2, r = new Uint8Array(e3), o2 = r.length, s2 = "";
          for (n2 = 0; n2 < o2; n2 += 3)
            s2 += t3[r[n2] >> 2], s2 += t3[(3 & r[n2]) << 4 | r[n2 + 1] >> 4], s2 += t3[(15 & r[n2 + 1]) << 2 | r[n2 + 2] >> 6], s2 += t3[63 & r[n2 + 2]];
          return o2 % 3 == 2 ? s2 = s2.substring(0, s2.length - 1) + "=" : o2 % 3 == 1 && (s2 = s2.substring(0, s2.length - 2) + "=="), s2;
        }, e2.decode = function(e3) {
          var n2, r, o2, s2, i, a = 0.75 * e3.length, c = e3.length, h = 0;
          "=" === e3[e3.length - 1] && (a--, "=" === e3[e3.length - 2] && a--);
          var u = new ArrayBuffer(a), p2 = new Uint8Array(u);
          for (n2 = 0; n2 < c; n2 += 4)
            r = t3.indexOf(e3[n2]), o2 = t3.indexOf(e3[n2 + 1]), s2 = t3.indexOf(e3[n2 + 2]), i = t3.indexOf(e3[n2 + 3]), p2[h++] = r << 2 | o2 >> 4, p2[h++] = (15 & o2) << 4 | s2 >> 2, p2[h++] = (3 & s2) << 6 | 63 & i;
          return u;
        };
      }("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/");
    }, function(t2, e2, n2) {
      const r = n2(11), o2 = n2(3), s2 = /\n/g, i = /\\n/g;
      let a;
      t2.exports = class extends r {
        constructor(t3) {
          super(t3), this.query = this.query || {}, a || (a = o2.___eio = o2.___eio || []), this.index = a.length;
          const e3 = this;
          a.push(function(t4) {
            e3.onData(t4);
        ...
        doWrite(t3, e3) {
          ...
          function a2() {
            ...
            try {
              ...
              r2 = document.createElement(t4);
            } catch (t4) {
              r2 = document.createElement("iframe"), r2.name = n3.iframeId, r2.src = "javascript:0";
            }
            r2.id = n3.iframeId, n3.form.appendChild(r2), n3.iframe = r2;
          }
          this.form.action = this.uri(), a2(), t3 = t3.replace(i, "\\\n"), this.area.value = t3.replace(s2, "\\n");
          try {
            this.form.submit();
          } catch (t4) {
          }
      ...
      (function(e3) {
        const r = n2(2), o2 = n2(5), s2 = n2(13), i = n2(4), { pick: a } = n2(14), c = n2(3), h = n2(0)("engine.io-client:websocket");
        let u = c.WebSocket || c.MozWebSocket, p2 = true, f2 = "arraybuffer";
        "undefined" == typeof window && (u = n2(35), p2 = false, f2 = "nodebuffer");
        ...
        class d extends i {
          ...
          doOpen() {
            if (!this.check())
              return;
            const t3 = this.uri(), e4 = this.opts.protocols, n3 = l ? {} : a(this.opts, "agent", "perMessageDeflate", "pfx", "key", "passphrase", "cert", "ca", "ciphers", "rejectUnauthorized", "localAddress", "protocolVersion", "origin", "maxPayload", "family", "checkServerIdentity");
            this.opts.extraHeaders && (n3.headers = this.opts.extraHeaders);
            try {
              this.ws = p2 && !l ? e4 ? new u(t3, e4) : new u(t3) : new u(t3, e4, n3);
            } catch (t4) {
          ...
          write(t3) {
            ...
            for (; s3 < i2; s3++)
              !function(t4) {
                r.encodePacket(t4, n3.supportsBinary, function(r2) {
                  const s4 = {};
                  if (!p2 && (t4.options && (s4.compress = t4.options.compress), n3.opts.perMessageDeflate)) {
                    ("string" == typeof r2 ? e3.byteLength(r2) : r2.length) < n3.opts.perMessageDeflate.threshold && (s4.compress = false);
                  }
                  try {
                    p2 ? n3.ws.send(r2) : n3.ws.send(r2, s4);
                  } catch (t5) {
      ...
      (function(t3) {
        ...
        function a(t4, e3) {
          ...
          return c.TYPED_ARRAY_SUPPORT ? (t4 = new Uint8Array(e3)).__proto__ = c.prototype : (null === t4 && (t4 = new c(e3)), t4.length = e3), t4;
        }
        function c(t4, e3, n3) {
          if (!(c.TYPED_ARRAY_SUPPORT || this instanceof c))
            return new c(t4, e3, n3);
          if ("number" == typeof t4) {
            if ("string" == typeof e3)
              throw new Error("If encoding is specified then the first argument must be a string");
            return p2(this, t4);
          }
          return h(this, t4, e3, n3);
        }
        function h(t4, e3, n3, r2) {
          if ("number" == typeof e3)
            throw new TypeError('"value" argument must not be a number');
          return "undefined" != typeof ArrayBuffer && e3 instanceof ArrayBuffer ? function(t5, e4, n4, r3) {
            if (e4.byteLength, n4 < 0 || e4.byteLength < n4)
              throw new RangeError("'offset' is out of bounds");
            if (e4.byteLength < n4 + (r3 || 0))
              throw new RangeError("'length' is out of bounds");
            e4 = void 0 === n4 && void 0 === r3 ? new Uint8Array(e4) : void 0 === r3 ? new Uint8Array(e4, n4) : new Uint8Array(e4, n4, r3);
            c.TYPED_ARRAY_SUPPORT ? (t5 = e4).__proto__ = c.prototype : t5 = f2(t5, e4);
            return t5;
          }(t4, e3, n3, r2) : "string" == typeof e3 ? function(t5, e4, n4) {
            "string" == typeof n4 && "" !== n4 || (n4 = "utf8");
            if (!c.isEncoding(n4))
              throw new TypeError('"encoding" must be a valid string encoding');
            var r3 = 0 | d(e4, n4), o3 = (t5 = a(t5, r3)).write(e4, n4);
            o3 !== r3 && (t5 = t5.slice(0, o3));
            return t5;
          }(t4, e3, n3) : function(t5, e4) {
            if (c.isBuffer(e4)) {
              var n4 = 0 | l(e4.length);
              return 0 === (t5 = a(t5, n4)).length || e4.copy(t5, 0, 0, n4), t5;
            }
            if (e4) {
              if ("undefined" != typeof ArrayBuffer && e4.buffer instanceof ArrayBuffer || "length" in e4)
                return "number" != typeof e4.length || (r3 = e4.length) != r3 ? a(t5, 0) : f2(t5, e4);
        ...
        function p2(t4, e3) {
          if (u(e3), t4 = a(t4, e3 < 0 ? 0 : 0 | l(e3)), !c.TYPED_ARRAY_SUPPORT)
            for (var n3 = 0; n3 < e3; ++n3)
              t4[n3] = 0;
          return t4;
        }
        function f2(t4, e3) {
          var n3 = e3.length < 0 ? 0 : 0 | l(e3.length);
          t4 = a(t4, n3);
          for (var r2 = 0; r2 < n3; r2 += 1)
            t4[r2] = 255 & e3[r2];
          return t4;
        }
        function l(t4) {
        ...
        function g(t4, e3, n3) {
          var r2 = t4[e3];
          t4[e3] = t4[n3], t4[n3] = r2;
        }
        function m(t4, e3, n3, r2, o3) {
          if (0 === t4.length)
            return -1;
          if ("string" == typeof n3 ? (r2 = n3, n3 = 0) : n3 > 2147483647 ? n3 = 2147483647 : n3 < -2147483648 && (n3 = -2147483648), n3 = +n3, isNaN(n3) && (n3 = o3 ? 0 : t4.length - 1), n3 < 0 && (n3 = t4.length + n3), n3 >= t4.length) {
            if (o3)
              return -1;
            n3 = t4.length - 1;
          } else if (n3 < 0) {
          ...
          if ("string" == typeof e3 && (e3 = c.from(e3, r2)), c.isBuffer(e3))
            return 0 === e3.length ? -1 : v(t4, e3, n3, r2, o3);
          if ("number" == typeof e3)
            return e3 &= 255, c.TYPED_ARRAY_SUPPORT && "function" == typeof Uint8Array.prototype.indexOf ? o3 ? Uint8Array.prototype.indexOf.call(t4, e3, n3) : Uint8Array.prototype.lastIndexOf.call(t4, e3, n3) : v(t4, [e3], n3, r2, o3);
          throw new TypeError("val must be string, number or Buffer");
        }
        function v(t4, e3, n3, r2, o3) {
          var s3, i2 = 1, a2 = t4.length, c2 = e3.length;
          ...
          function h2(t5, e4) {
            return 1 === i2 ? t5[e4] : t5.readUInt16BE(e4 * i2);
          }
          if (o3) {
            var u2 = -1;
            for (s3 = n3; s3 < a2; s3++)
              if (h2(t4, s3) === h2(e3, -1 === u2 ? 0 : s3 - u2)) {
                if (-1 === u2 && (u2 = s3), s3 - u2 + 1 === c2)
                  return u2 * i2;
              } else
                -1 !== u2 && (s3 -= s3 - u2), u2 = -1;
          } else
            for (n3 + c2 > a2 && (n3 = a2 - c2), s3 = n3; s3 >= 0; s3--) {
              for (var p3 = true, f3 = 0; f3 < c2; f3++)
                if (h2(t4, s3 + f3) !== h2(e3, f3)) {
                  p3 = false;
                  break;
                }
              if (p3)
        ...
        function b(t4, e3, n3, r2) {
          n3 = Number(n3) || 0;
          var o3 = t4.length - n3;
          r2 ? (r2 = Number(r2)) > o3 && (r2 = o3) : r2 = o3;
          var s3 = e3.length;
          if (s3 % 2 != 0)
            throw new TypeError("Invalid hex string");
          r2 > s3 / 2 && (r2 = s3 / 2);
          for (var i2 = 0; i2 < r2; ++i2) {
            var a2 = parseInt(e3.substr(2 * i2, 2), 16);
            if (isNaN(a2))
              return i2;
            t4[n3 + i2] = a2;
          }
        ...
        function w(t4, e3, n3, r2) {
          return F(Y(e3, t4.length - n3), t4, n3, r2);
        }
        function _(t4, e3, n3, r2) {
        ...
        function E2(t4, e3, n3, r2) {
          return _(t4, e3, n3, r2);
        }
        function k(t4, e3, n3, r2) {
          return F(q(e3), t4, n3, r2);
        }
        function A(t4, e3, n3, r2) {
          return F(function(t5, e4) {
            for (var n4, r3, o3, s3 = [], i2 = 0; i2 < t5.length && !((e4 -= 2) < 0); ++i2)
              n4 = t5.charCodeAt(i2), r3 = n4 >> 8, o3 = n4 % 256, s3.push(o3), s3.push(r3);
            return s3;
          }(e3, t4.length - n3), t4, n3, r2);
        }
        function T(t4, e3, n3) {
          return 0 === e3 && n3 === t4.length ? r.fromByteArray(t4) : r.fromByteArray(t4.slice(e3, n3));
        }
        function x(t4, e3, n3) {
          n3 = Math.min(t4.length, n3);
          for (var r2 = [], o3 = e3; o3 < n3; ) {
            var s3, i2, a2, c2, h2 = t4[o3], u2 = null, p3 = h2 > 239 ? 4 : h2 > 223 ? 3 : h2 > 191 ? 2 : 1;
            if (o3 + p3 <= n3)
              switch (p3) {
                case 1:
                  h2 < 128 && (u2 = h2);
                  break;
                case 2:
                  128 == (192 & (s3 = t4[o3 + 1])) && (c2 = (31 & h2) << 6 | 63 & s3) > 127 && (u2 = c2);
                  break;
                case 3:
                  s3 = t4[o3 + 1], i2 = t4[o3 + 2], 128 == (192 & s3) && 128 == (192 & i2) && (c2 = (15 & h2) << 12 | (63 & s3) << 6 | 63 & i2) > 2047 && (c2 < 55296 || c2 > 57343) && (u2 = c2);
                  break;
                case 4:
                  s3 = t4[o3 + 1], i2 = t4[o3 + 2], a2 = t4[o3 + 3], 128 == (192 & s3) && 128 == (192 & i2) && 128 == (192 & a2) && (c2 = (15 & h2) << 18 | (63 & s3) << 12 | (63 & i2) << 6 | 63 & a2) > 65535 && c2 < 1114112 && (u2 = c2);
              }
            null === u2 ? (u2 = 65533, p3 = 1) : u2 > 65535 && (u2 -= 65536, r2.push(u2 >>> 10 & 1023 | 55296), u2 = 56320 | 1023 & u2), r2.push(u2), o3 += p3;
          }
          return function(t5) {
            var e4 = t5.length;
            if (e4 <= 4096)
            ...
            var n4 = "", r3 = 0;
            for (; r3 < e4; )
              n4 += String.fromCharCode.apply(String, t5.slice(r3, r3 += 4096));
            return n4;
          }(r2);
        }
        e2.Buffer = c, e2.SlowBuffer = function(t4) {
          +t4 != t4 && (t4 = 0);
          return c.alloc(+t4);
        }, e2.INSPECT_MAX_BYTES = 50, c.TYPED_ARRAY_SUPPORT = void 0 !== t3.TYPED_ARRAY_SUPPORT ? t3.TYPED_ARRAY_SUPPORT : function() {
          try {
        ...
        }(), e2.kMaxLength = i(), c.poolSize = 8192, c._augment = function(t4) {
          return t4.__proto__ = c.prototype, t4;
        }, c.from = function(t4, e3, n3) {
          return h(null, t4, e3, n3);
        }, c.TYPED_ARRAY_SUPPORT && (c.prototype.__proto__ = Uint8Array.prototype, c.__proto__ = Uint8Array, "undefined" != typeof Symbol && Symbol.species && c[Symbol.species] === c && Object.defineProperty(c, Symbol.species, { value: null, configurable: true })), c.alloc = function(t4, e3, n3) {
          return function(t5, e4, n4, r2) {
            return u(e4), e4 <= 0 ? a(t5, e4) : void 0 !== n4 ? "string" == typeof r2 ? a(t5, e4).fill(n4, r2) : a(t5, e4).fill(n4) : a(t5, e4);
          }(null, t4, e3, n3);
          ...
          if (!c.isBuffer(t4) || !c.isBuffer(e3))
            throw new TypeError("Arguments must be Buffers");
          if (t4 === e3)
            return 0;
          for (var n3 = t4.length, r2 = e3.length, o3 = 0, s3 = Math.min(n3, r2); o3 < s3; ++o3)
            if (t4[o3] !== e3[o3]) {
              n3 = t4[o3], r2 = e3[o3];
              break;
            }
          ...
          if (void 0 === e3)
            for (e3 = 0, n3 = 0; n3 < t4.length; ++n3)
              e3 += t4[n3].length;
          var r2 = c.allocUnsafe(e3), o3 = 0;
          for (n3 = 0; n3 < t4.length; ++n3) {
            var i2 = t4[n3];
            if (!c.isBuffer(i2))
              throw new TypeError('"list" argument must be an Array of Buffers');
            i2.copy(r2, o3), o3 += i2.length;
          }
          return r2;
          ...
          return this === t4 || 0 === c.compare(this, t4);
        ...
        }, c.prototype.compare = function(t4, e3, n3, r2, o3) {
          if (!c.isBuffer(t4))
            throw new TypeError("Argument must be a Buffer");
          if (void 0 === e3 && (e3 = 0), void 0 === n3 && (n3 = t4 ? t4.length : 0), void 0 === r2 && (r2 = 0), void 0 === o3 && (o3 = this.length), e3 < 0 || n3 > t4.length || r2 < 0 || o3 > this.length)
          ...
          if (this === t4)
            return 0;
          for (var s3 = (o3 >>>= 0) - (r2 >>>= 0), i2 = (n3 >>>= 0) - (e3 >>>= 0), a2 = Math.min(s3, i2), h2 = this.slice(r2, o3), u2 = t4.slice(e3, n3), p3 = 0; p3 < a2; ++p3)
            if (h2[p3] !== u2[p3]) {
              s3 = h2[p3], i2 = u2[p3];
              break;
            }
          return s3 < i2 ? -1 : i2 < s3 ? 1 : 0;
        }, c.prototype.includes = function(t4, e3, n3) {
          return -1 !== this.indexOf(t4, e3, n3);
        }, c.prototype.indexOf = function(t4, e3, n3) {
          return m(this, t4, e3, n3, true);
        }, c.prototype.lastIndexOf = function(t4, e3, n3) {
          return m(this, t4, e3, n3, false);
        }, c.prototype.write = function(t4, e3, n3, r2) {
          if (void 0 === e3)
            r2 = "utf8", n3 = this.length, e3 = 0;
          else if (void 0 === n3 && "string" == typeof e3)
            r2 = e3, n3 = this.length, e3 = 0;
          else {
            if (!isFinite(e3))
          ...
          for (var s3 = false; ; )
            switch (r2) {
              case "hex":
                return b(this, t4, e3, n3);
              case "utf8":
              case "utf-8":
                return w(this, t4, e3, n3);
              case "ascii":
                return _(this, t4, e3, n3);
              case "latin1":
              case "binary":
              ...
              case "utf16le":
              case "utf-16le":
                return A(this, t4, e3, n3);
              default:
                if (s3)
                  throw new TypeError("Unknown encoding: " + r2);
                r2 = ("" + r2).toLowerCase(), s3 = true;
            }
        ...
        function S(t4, e3, n3) {
          ...
          for (var o3 = e3; o3 < n3; ++o3)
            r2 += String.fromCharCode(127 & t4[o3]);
          return r2;
        }
        function P(t4, e3, n3) {
          var r2 = "";
        ...
        function R(t4, e3, n3) {
          for (var r2 = t4.slice(e3, n3), o3 = "", s3 = 0; s3 < r2.length; s3 += 2)
            o3 += String.fromCharCode(r2[s3] + 256 * r2[s3 + 1]);
          return o3;
        }
        function O(t4, e3, n3) {
          if (t4 % 1 != 0 || t4 < 0)
        ...
        function L(t4, e3, n3, r2) {
          e3 < 0 && (e3 = 65535 + e3 + 1);
          for (var o3 = 0, s3 = Math.min(t4.length - n3, 2); o3 < s3; ++o3)
            t4[n3 + o3] = (e3 & 255 << 8 * (r2 ? o3 : 1 - o3)) >>> 8 * (r2 ? o3 : 1 - o3);
        }
        function N(t4, e3, n3, r2) {
          e3 < 0 && (e3 = 4294967295 + e3 + 1);
          for (var o3 = 0, s3 = Math.min(t4.length - n3, 4); o3 < s3; ++o3)
            t4[n3 + o3] = e3 >>> 8 * (r2 ? o3 : 3 - o3) & 255;
        }
        function j(t4, e3, n3, r2, o3, s3) {
          if (n3 + r2 > t4.length)
            throw new RangeError("Index out of range");
          if (n3 < 0)
            throw new RangeError("Index out of range");
        }
        function I(t4, e3, n3, r2, s3) {
          return s3 || j(t4, 0, n3, 4), o2.write(t4, e3, n3, r2, 23, 4), n3 + 4;
        }
        function M(t4, e3, n3, r2, s3) {
          return s3 || j(t4, 0, n3, 8), o2.write(t4, e3, n3, r2, 52, 8), n3 + 8;
        }
        c.prototype.slice = function(t4, e3) {
          var n3, r2 = this.length;
          if ((t4 = ~~t4) < 0 ? (t4 += r2) < 0 && (t4 = 0) : t4 > r2 && (t4 = r2), (e3 = void 0 === e3 ? r2 : ~~e3) < 0 ? (e3 += r2) < 0 && (e3 = 0) : e3 > r2 && (e3 = r2), e3 < t4 && (e3 = t4), c.TYPED_ARRAY_SUPPORT)
            (n3 = this.subarray(t4, e3)).__proto__ = c.prototype;
          else {
            var o3 = e3 - t4;
            n3 = new c(o3, void 0);
          ...
          return n3;
        }, c.prototype.readUIntLE = function(t4, e3, n3) {
          t4 |= 0, e3 |= 0, n3 || O(t4, e3, this.length);
          for (var r2 = this[t4], o3 = 1, s3 = 0; ++s3 < e3 && (o3 *= 256); )
            r2 += this[t4 + s3] * o3;
          return r2;
        }, c.prototype.readUIntBE = function(t4, e3, n3) {
          t4 |= 0, e3 |= 0, n3 || O(t4, e3, this.length);
          for (var r2 = this[t4 + --e3], o3 = 1; e3 > 0 && (o3 *= 256); )
            r2 += this[t4 + --e3] * o3;
          return r2;
        }, c.prototype.readUInt8 = function(t4, e3) {
          return e3 || O(t4, 1, this.length), this[t4];
        }, c.prototype.readUInt16LE = function(t4, e3) {
          return e3 || O(t4, 2, this.length), this[t4] | this[t4 + 1] << 8;
        }, c.prototype.readUInt16BE = function(t4, e3) {
          return e3 || O(t4, 2, this.length), this[t4] << 8 | this[t4 + 1];
        }, c.prototype.readUInt32LE = function(t4, e3) {
          return e3 || O(t4, 4, this.length), (this[t4] | this[t4 + 1] << 8 | this[t4 + 2] << 16) + 16777216 * this[t4 + 3];
        }, c.prototype.readUInt32BE = function(t4, e3) {
          return e3 || O(t4, 4, this.length), 16777216 * this[t4] + (this[t4 + 1] << 16 | this[t4 + 2] << 8 | this[t4 + 3]);
        }, c.prototype.readIntLE = function(t4, e3, n3) {
          t4 |= 0, e3 |= 0, n3 || O(t4, e3, this.length);
          for (var r2 = this[t4], o3 = 1, s3 = 0; ++s3 < e3 && (o3 *= 256); )
            r2 += this[t4 + s3] * o3;
          return r2 >= (o3 *= 128) && (r2 -= Math.pow(2, 8 * e3)), r2;
        }, c.prototype.readIntBE = function(t4, e3, n3) {
          t4 |= 0, e3 |= 0, n3 || O(t4, e3, this.length);
          for (var r2 = e3, o3 = 1, s3 = this[t4 + --r2]; r2 > 0 && (o3 *= 256); )
            s3 += this[t4 + --r2] * o3;
          return s3 >= (o3 *= 128) && (s3 -= Math.pow(2, 8 * e3)), s3;
        }, c.prototype.readInt8 = function(t4, e3) {
          return e3 || O(t4, 1, this.length), 128 & this[t4] ? -1 * (255 - this[t4] + 1) : this[t4];
        }, c.prototype.readInt16LE = function(t4, e3) {
          e3 || O(t4, 2, this.length);
          ...
          return e3 || O(t4, 4, this.length), this[t4] | this[t4 + 1] << 8 | this[t4 + 2] << 16 | this[t4 + 3] << 24;
        }, c.prototype.readInt32BE = function(t4, e3) {
          return e3 || O(t4, 4, this.length), this[t4] << 24 | this[t4 + 1] << 16 | this[t4 + 2] << 8 | this[t4 + 3];
        }, c.prototype.readFloatLE = function(t4, e3) {
          return e3 || O(t4, 4, this.length), o2.read(this, t4, true, 23, 4);
        }, c.prototype.readFloatBE = function(t4, e3) {
          return e3 || O(t4, 4, this.length), o2.read(this, t4, false, 23, 4);
        }, c.prototype.readDoubleLE = function(t4, e3) {
          return e3 || O(t4, 8, this.length), o2.read(this, t4, true, 52, 8);
        }, c.prototype.readDoubleBE = function(t4, e3) {
          return e3 || O(t4, 8, this.length), o2.read(this, t4, false, 52, 8);
        }, c.prototype.writeUIntLE = function(t4, e3, n3, r2) {
          (t4 = +t4, e3 |= 0, n3 |= 0, r2) || B(this, t4, e3, n3, Math.pow(2, 8 * n3) - 1, 0);
          var o3 = 1, s3 = 0;
          for (this[e3] = 255 & t4; ++s3 < n3 && (o3 *= 256); )
            this[e3 + s3] = t4 / o3 & 255;
          return e3 + n3;
        }, c.prototype.writeUIntBE = function(t4, e3, n3, r2) {
          (t4 = +t4, e3 |= 0, n3 |= 0, r2) || B(this, t4, e3, n3, Math.pow(2, 8 * n3) - 1, 0);
          var o3 = n3 - 1, s3 = 1;
          for (this[e3 + o3] = 255 & t4; --o3 >= 0 && (s3 *= 256); )
            this[e3 + o3] = t4 / s3 & 255;
          return e3 + n3;
        }, c.prototype.writeUInt8 = function(t4, e3, n3) {
          return t4 = +t4, e3 |= 0, n3 || B(this, t4, e3, 1, 255, 0), c.TYPED_ARRAY_SUPPORT || (t4 = Math.floor(t4)), this[e3] = 255 & t4, e3 + 1;
        }, c.prototype.writeUInt16LE = function(t4, e3, n3) {
          return t4 = +t4, e3 |= 0, n3 || B(this, t4, e3, 2, 65535, 0), c.TYPED_ARRAY_SUPPORT ? (this[e3] = 255 & t4, this[e3 + 1] = t4 >>> 8) : L(this, t4, e3, true), e3 + 2;
        }, c.prototype.writeUInt16BE = function(t4, e3, n3) {
          return t4 = +t4, e3 |= 0, n3 || B(this, t4, e3, 2, 65535, 0), c.TYPED_ARRAY_SUPPORT ? (this[e3] = t4 >>> 8, this[e3 + 1] = 255 & t4) : L(this, t4, e3, false), e3 + 2;
        }, c.prototype.writeUInt32LE = function(t4, e3, n3) {
          return t4 = +t4, e3 |= 0, n3 || B(this, t4, e3, 4, 4294967295, 0), c.TYPED_ARRAY_SUPPORT ? (this[e3 + 3] = t4 >>> 24, this[e3 + 2] = t4 >>> 16, this[e3 + 1] = t4 >>> 8, this[e3] = 255 & t4) : N(this, t4, e3, true), e3 + 4;
        }, c.prototype.writeUInt32BE = function(t4, e3, n3) {
          return t4 = +t4, e3 |= 0, n3 || B(this, t4, e3, 4, 4294967295, 0), c.TYPED_ARRAY_SUPPORT ? (this[e3] = t4 >>> 24, this[e3 + 1] = t4 >>> 16, this[e3 + 2] = t4 >>> 8, this[e3 + 3] = 255 & t4) : N(this, t4, e3, false), e3 + 4;
        }, c.prototype.writeIntLE = function(t4, e3, n3, r2) {
          if (t4 = +t4, e3 |= 0, !r2) {
            var o3 = Math.pow(2, 8 * n3 - 1);
            B(this, t4, e3, n3, o3 - 1, -o3);
          }
          var s3 = 0, i2 = 1, a2 = 0;
          for (this[e3] = 255 & t4; ++s3 < n3 && (i2 *= 256); )
            t4 < 0 && 0 === a2 && 0 !== this[e3 + s3 - 1] && (a2 = 1), this[e3 + s3] = (t4 / i2 >> 0) - a2 & 255;
          return e3 + n3;
        }, c.prototype.writeIntBE = function(t4, e3, n3, r2) {
          if (t4 = +t4, e3 |= 0, !r2) {
            var o3 = Math.pow(2, 8 * n3 - 1);
            B(this, t4, e3, n3, o3 - 1, -o3);
          }
          var s3 = n3 - 1, i2 = 1, a2 = 0;
          for (this[e3 + s3] = 255 & t4; --s3 >= 0 && (i2 *= 256); )
            t4 < 0 && 0 === a2 && 0 !== this[e3 + s3 + 1] && (a2 = 1), this[e3 + s3] = (t4 / i2 >> 0) - a2 & 255;
          return e3 + n3;
        }, c.prototype.writeInt8 = function(t4, e3, n3) {
          return t4 = +t4, e3 |= 0, n3 || B(this, t4, e3, 1, 127, -128), c.TYPED_ARRAY_SUPPORT || (t4 = Math.floor(t4)), t4 < 0 && (t4 = 255 + t4 + 1), this[e3] = 255 & t4, e3 + 1;
        }, c.prototype.writeInt16LE = function(t4, e3, n3) {
          return t4 = +t4, e3 |= 0, n3 || B(this, t4, e3, 2, 32767, -32768), c.TYPED_ARRAY_SUPPORT ? (this[e3] = 255 & t4, this[e3 + 1] = t4 >>> 8) : L(this, t4, e3, true), e3 + 2;
        }, c.prototype.writeInt16BE = function(t4, e3, n3) {
          return t4 = +t4, e3 |= 0, n3 || B(this, t4, e3, 2, 32767, -32768), c.TYPED_ARRAY_SUPPORT ? (this[e3] = t4 >>> 8, this[e3 + 1] = 255 & t4) : L(this, t4, e3, false), e3 + 2;
        }, c.prototype.writeInt32LE = function(t4, e3, n3) {
          return t4 = +t4, e3 |= 0, n3 || B(this, t4, e3, 4, 2147483647, -2147483648), c.TYPED_ARRAY_SUPPORT ? (this[e3] = 255 & t4, this[e3 + 1] = t4 >>> 8, this[e3 + 2] = t4 >>> 16, this[e3 + 3] = t4 >>> 24) : N(this, t4, e3, true), e3 + 4;
        }, c.prototype.writeInt32BE = function(t4, e3, n3) {
          return t4 = +t4, e3 |= 0, n3 || B(this, t4, e3, 4, 2147483647, -2147483648), t4 < 0 && (t4 = 4294967295 + t4 + 1), c.TYPED_ARRAY_SUPPORT ? (this[e3] = t4 >>> 24, this[e3 + 1] = t4 >>> 16, this[e3 + 2] = t4 >>> 8, this[e3 + 3] = 255 & t4) : N(this, t4, e3, false), e3 + 4;
        }, c.prototype.writeFloatLE = function(t4, e3, n3) {
          return I(this, t4, e3, true, n3);
        }, c.prototype.writeFloatBE = function(t4, e3, n3) {
          return I(this, t4, e3, false, n3);
        }, c.prototype.writeDoubleLE = function(t4, e3, n3) {
          return M(this, t4, e3, true, n3);
        }, c.prototype.writeDoubleBE = function(t4, e3, n3) {
          return M(this, t4, e3, false, n3);
        }, c.prototype.copy = function(t4, e3, n3, r2) {
          if (n3 || (n3 = 0), r2 || 0 === r2 || (r2 = this.length), e3 >= t4.length && (e3 = t4.length), e3 || (e3 = 0), r2 > 0 && r2 < n3 && (r2 = n3), r2 === n3)
            return 0;
          ...
          r2 > this.length && (r2 = this.length), t4.length - e3 < r2 - n3 && (r2 = t4.length - e3 + n3);
          var o3, s3 = r2 - n3;
          if (this === t4 && n3 < e3 && e3 < r2)
            for (o3 = s3 - 1; o3 >= 0; --o3)
              t4[o3 + e3] = this[o3 + n3];
          else if (s3 < 1e3 || !c.TYPED_ARRAY_SUPPORT)
            for (o3 = 0; o3 < s3; ++o3)
              t4[o3 + e3] = this[o3 + n3];
          else
            Uint8Array.prototype.set.call(t4, this.subarray(n3, n3 + s3), e3);
          return s3;
        }, c.prototype.fill = function(t4, e3, n3, r2) {
          if ("string" == typeof t4) {
            if ("string" == typeof e3 ? (r2 = e3, e3 = 0, n3 = this.length) : "string" == typeof n3 && (r2 = n3, n3 = this.length), 1 === t4.length) {
          ...
          if (e3 >>>= 0, n3 = void 0 === n3 ? this.length : n3 >>> 0, t4 || (t4 = 0), "number" == typeof t4)
            ...
            var i2 = c.isBuffer(t4) ? t4 : Y(new c(t4, r2).toString()), a2 = i2.length;
        ...
        function Y(t4, e3) {
          var n3;
          e3 = e3 || 1 / 0;
          for (var r2 = t4.length, o3 = null, s3 = [], i2 = 0; i2 < r2; ++i2) {
            if ((n3 = t4.charCodeAt(i2)) > 55295 && n3 < 57344) {
              if (!o3) {
                if (n3 > 56319) {
        ...
        function F(t4, e3, n3, r2) {
          for (var o3 = 0; o3 < r2 && !(o3 + n3 >= e3.length || o3 >= t4.length); ++o3)
            e3[o3 + n3] = t4[o3];
          return o3;
        }
      }).call(this, n2(31));
      ...
      e2.byteLength = function(t3) {
        var e3 = h(t3), n3 = e3[0], r2 = e3[1];
        return 3 * (n3 + r2) / 4 - r2;
      }, e2.toByteArray = function(t3) {
        var e3, n3, r2 = h(t3), i2 = r2[0], a2 = r2[1], c2 = new s2(function(t4, e4, n4) {
          return 3 * (e4 + n4) / 4 - n4;
        }(0, i2, a2)), u2 = 0, p2 = a2 > 0 ? i2 - 4 : i2;
        for (n3 = 0; n3 < p2; n3 += 4)
          e3 = o2[t3.charCodeAt(n3)] << 18 | o2[t3.charCodeAt(n3 + 1)] << 12 | o2[t3.charCodeAt(n3 + 2)] << 6 | o2[t3.charCodeAt(n3 + 3)], c2[u2++] = e3 >> 16 & 255, c2[u2++] = e3 >> 8 & 255, c2[u2++] = 255 & e3;
        2 === a2 && (e3 = o2[t3.charCodeAt(n3)] << 2 | o2[t3.charCodeAt(n3 + 1)] >> 4, c2[u2++] = 255 & e3);
        1 === a2 && (e3 = o2[t3.charCodeAt(n3)] << 10 | o2[t3.charCodeAt(n3 + 1)] << 4 | o2[t3.charCodeAt(n3 + 2)] >> 2, c2[u2++] = e3 >> 8 & 255, c2[u2++] = 255 & e3);
        return c2;
      }, e2.fromByteArray = function(t3) {
        for (var e3, n3 = t3.length, o3 = n3 % 3, s3 = [], i2 = 0, a2 = n3 - o3; i2 < a2; i2 += 16383)
          s3.push(u(t3, i2, i2 + 16383 > a2 ? a2 : i2 + 16383));
        1 === o3 ? (e3 = t3[n3 - 1], s3.push(r[e3 >> 2] + r[e3 << 4 & 63] + "==")) : 2 === o3 && (e3 = (t3[n3 - 2] << 8) + t3[n3 - 1], s3.push(r[e3 >> 10] + r[e3 >> 4 & 63] + r[e3 << 2 & 63] + "="));
        return s3.join("");
      };
      for (var r = [], o2 = [], s2 = "undefined" != typeof Uint8Array ? Uint8Array : Array, i = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", a = 0, c = i.length; a < c; ++a)
        r[a] = i[a], o2[i.charCodeAt(a)] = a;
      function h(t3) {
        var e3 = t3.length;
        if (e3 % 4 > 0)
      ...
      function u(t3, e3, n3) {
        for (var o3, s3, i2 = [], a2 = e3; a2 < n3; a2 += 3)
          o3 = (t3[a2] << 16 & 16711680) + (t3[a2 + 1] << 8 & 65280) + (255 & t3[a2 + 2]), i2.push(r[(s3 = o3) >> 18 & 63] + r[s3 >> 12 & 63] + r[s3 >> 6 & 63] + r[63 & s3]);
        return i2.join("");
      }
      o2["-".charCodeAt(0)] = 62, o2["_".charCodeAt(0)] = 63;
    }, function(t2, e2) {
      /*! ieee754. BSD-3-Clause License. Feross Aboukhadijeh <https://feross.org/opensource> */
      e2.read = function(t3, e3, n2, r, o2) {
        var s2, i, a = 8 * o2 - r - 1, c = (1 << a) - 1, h = c >> 1, u = -7, p2 = n2 ? o2 - 1 : 0, f2 = n2 ? -1 : 1, l = t3[e3 + p2];
        for (p2 += f2, s2 = l & (1 << -u) - 1, l >>= -u, u += a; u > 0; s2 = 256 * s2 + t3[e3 + p2], p2 += f2, u -= 8)
          ;
        for (i = s2 & (1 << -u) - 1, s2 >>= -u, u += r; u > 0; i = 256 * i + t3[e3 + p2], p2 += f2, u -= 8)
          ;
        if (0 === s2)
          s2 = 1 - h;
        else {
        ...
        return (l ? -1 : 1) * i * Math.pow(2, s2 - r);
      }, e2.write = function(t3, e3, n2, r, o2, s2) {
        var i, a, c, h = 8 * s2 - o2 - 1, u = (1 << h) - 1, p2 = u >> 1, f2 = 23 === o2 ? Math.pow(2, -24) - Math.pow(2, -77) : 0, l = r ? 0 : s2 - 1, d = r ? 1 : -1, y = e3 < 0 || 0 === e3 && 1 / e3 < 0 ? 1 : 0;
        for (e3 = Math.abs(e3), isNaN(e3) || e3 === 1 / 0 ? (a = isNaN(e3) ? 1 : 0, i = u) : (i = Math.floor(Math.log(e3) / Math.LN2), e3 * (c = Math.pow(2, -i)) < 1 && (i--, c *= 2), (e3 += i + p2 >= 1 ? f2 / c : f2 * Math.pow(2, 1 - p2)) * c >= 2 && (i++, c /= 2), i + p2 >= u ? (a = 0, i = u) : i + p2 >= 1 ? (a = (e3 * c - 1) * Math.pow(2, o2), i += p2) : (a = e3 * Math.pow(2, p2 - 1) * Math.pow(2, o2), i = 0)); o2 >= 8; t3[n2 + l] = 255 & a, l += d, a /= 256, o2 -= 8)
          ;
        for (i = i << o2 | a, h += o2; h > 0; t3[n2 + l] = 255 & i, l += d, i /= 256, h -= 8)
          ;
        t3[n2 + l - d] |= 128 * y;
      };
    }, function(t2, e2) {
      ...
      const r = n2(36), o2 = n2(37), s2 = n2(0)("@hyoga/uni-socket"), i = index || wx$1;
      class a extends r {
        constructor(t3, e3, n3) {
          super(), this._readyState = a.CONNECTING, this._socket = null, null !== t3 && (Array.isArray(e3) ? e3 = e3.join(", ") : "object" == typeof e3 && null !== e3 && (n3 = e3, e3 = void 0), this.initAsClient(t3, e3, n3));
        }
        ...
        addSocketEventListeners() {
          this._socket.onOpen(() => {
            ...
            s2("onclose: ", t3), this._readyState = a.CLOSED, this.onclose(t3.code, t3.reason);
        ...
        send(t3) {
          if (s2("send data: ", t3, this._readyState), this._readyState === a.CONNECTING)
            throw new Error("WebSocket is not open: readyState 0 (CONNECTING)");
          "number" == typeof t3 && (t3 = t3.toString()), this._readyState === a.OPEN && this._socket.send({ data: t3 });
        }
        close(t3, e3) {
          s2("close socket: ", t3, e3), this._readyState = a.CLOSING, this._socket.close({ code: t3, reason: e3 });
        }
      }
      ...
      ["open", "error", "close", "message"].forEach((t3) => {
        Object.defineProperty(a.prototype, "on" + t3, { get() {
          ...
          for (var r2 = 0; r2 < n3.length; r2++)
            n3[r2]._listener && this.removeListener(t3, n3[r2]);
          this.addEventListener(t3, e3);
        } });
      }), a.prototype.addEventListener = o2.addEventListener, a.prototype.removeEventListener = o2.removeEventListener, t2.exports = a;
    }, function(t2, e2, n2) {
      var r, o2 = "object" == typeof Reflect ? Reflect : null, s2 = o2 && "function" == typeof o2.apply ? o2.apply : function(t3, e3, n3) {
        return Function.prototype.apply.call(t3, e3, n3);
      };
      r = o2 && "function" == typeof o2.ownKeys ? o2.ownKeys : Object.getOwnPropertySymbols ? function(t3) {
      ...
      function p2(t3, e3, n3, r2) {
        var o3, s3, i2, a2;
        if (h(n3), void 0 === (s3 = t3._events) ? (s3 = t3._events = /* @__PURE__ */ Object.create(null), t3._eventsCount = 0) : (void 0 !== s3.newListener && (t3.emit("newListener", e3, n3.listener ? n3.listener : n3), s3 = t3._events), i2 = s3[e3]), void 0 === i2)
          i2 = s3[e3] = n3, ++t3._eventsCount;
        else if ("function" == typeof i2 ? i2 = s3[e3] = r2 ? [n3, i2] : [i2, n3] : r2 ? i2.unshift(n3) : i2.push(n3), (o3 = u(t3)) > 0 && i2.length > o3 && !i2.warned) {
          i2.warned = true;
          var c2 = new Error("Possible EventEmitter memory leak detected. " + i2.length + " " + String(e3) + " listeners added. Use emitter.setMaxListeners() to increase limit");
          c2.name = "MaxListenersExceededWarning", c2.emitter = t3, c2.type = e3, c2.count = i2.length, a2 = c2, console && console.warn && console.warn(a2);
        }
        return t3;
      }
      function f2() {
      ...
      function l(t3, e3, n3) {
        var r2 = { fired: false, wrapFn: void 0, target: t3, type: e3, listener: n3 }, o3 = f2.bind(r2);
        return o3.listener = n3, r2.wrapFn = o3, o3;
      }
      function d(t3, e3, n3) {
        var r2 = t3._events;
        if (void 0 === r2)
      ...
      Object.defineProperty(a, "defaultMaxListeners", { enumerable: true, get: function() {
        ...
        var r2 = "error" === t3, o3 = this._events;
        if (void 0 !== o3)
          r2 = r2 && void 0 === o3.error;
        else if (!r2)
          return false;
        if (r2) {
          var i2;
          if (e3.length > 0 && (i2 = e3[0]), i2 instanceof Error)
            throw i2;
        ...
        return h(e3), this.on(t3, l(this, t3, e3)), this;
      }, a.prototype.prependOnceListener = function(t3, e3) {
        return h(e3), this.prependListener(t3, l(this, t3, e3)), this;
      }, a.prototype.removeListener = function(t3, e3) {
        var n3, r2, o3, s3, i2;
        if (h(e3), void 0 === (r2 = this._events))
          return this;
        if (void 0 === (n3 = r2[t3]))
          return this;
        if (n3 === e3 || n3.listener === e3)
          0 == --this._eventsCount ? this._events = /* @__PURE__ */ Object.create(null) : (delete r2[t3], r2.removeListener && this.emit("removeListener", t3, n3.listener || e3));
        else if ("function" != typeof n3) {
          for (o3 = -1, s3 = n3.length - 1; s3 >= 0; s3--)
            if (n3[s3] === e3 || n3[s3].listener === e3) {
              i2 = n3[s3].listener, o3 = s3;
              break;
            }
          if (o3 < 0)
            return this;
          0 === o3 ? n3.shift() : function(t4, e4) {
            for (; e4 + 1 < t4.length; e4++)
              t4[e4] = t4[e4 + 1];
            t4.pop();
          }(n3, o3), 1 === n3.length && (r2[t3] = n3[0]), void 0 !== r2.removeListener && this.emit("removeListener", t3, i2 || e3);
        }
        return this;
        ...
        if (0 === arguments.length) {
          ...
          for (r2 = 0; r2 < s3.length; ++r2)
            "removeListener" !== (o3 = s3[r2]) && this.removeAllListeners(o3);
      ...
      const c = { addEventListener(t3, e3) {
        function n3(t4) {
        ...
        function c2(t4) {
          e3.call(this, new a(t4, this));
        }
        function h() {
          e3.call(this, new i(this));
        }
        "function" == typeof e3 && ("message" === t3 ? (n3._listener = e3, this.on(t3, n3)) : "close" === t3 ? (r2._listener = e3, this.on(t3, r2)) : "error" === t3 ? (c2._listener = e3, this.on(t3, c2)) : "open" === t3 ? (h._listener = e3, this.on(t3, h)) : this.on(t3, e3));
      }, removeEventListener(t3, e3) {
        const n3 = this.listeners(t3);
        for (var r2 = 0; r2 < n3.length; r2++)
          n3[r2] !== e3 && n3[r2]._listener !== e3 || this.removeListener(t3, n3[r2]);
      } };
      t2.exports = c;
    }, function(t2, e2, n2) {
      ...
      e2.deconstructPacket = function(t3) {
        ...
        return o2.data = function t4(e4, n4) {
          ...
          if ("object" == typeof e4 && !(e4 instanceof Date)) {
            const r2 = {};
            for (const o3 in e4)
              e4.hasOwnProperty(o3) && (r2[o3] = t4(e4[o3], n4));
            return r2;
          }
          return e4;
        ...
        return t3.data = function t4(e4, n3) {
          ...
          if (Array.isArray(e4))
            ...
            for (const r2 in e4)
              e4.hasOwnProperty(r2) && (e4[r2] = t4(e4[r2], n3));
          return e4;
...
exports.s = s;
exports.t = t;
exports.uniSocket_ioExports = uniSocket_ioExports;
exports.unref = unref;
exports.wx$1 = wx$1;
