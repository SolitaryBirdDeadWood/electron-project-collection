...
// 更新用户信息接口
export const reqUpdateUserInfo = (data: UpdateUserData) => request<any, UpdateUserResponseData>({url: API.UPDATEUSERINFO_URL, method: 'post', data: queryString.stringify(data)})
// 获取用户信息接口
export const reqGetUserInfo = (_id: string) => request<any>({url: API.GETUSERINFO_URL, method: 'get', params: { _id }})